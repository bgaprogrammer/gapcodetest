        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MaxPorcentajeCubrimiento = table.Column<int>(nullable: false),
                    Nombre = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Agencia_Ciudad_CiudadId",
                        column: x => x.CiudadId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(nullable: true),
                    PorcentajeCubrimiento = table.Column<int>(nullable: false),
                    Precio = table.Column<decimal>(nullable: false),
                    TipoCubrimientoId = table.Column<int>(nullable: true),
                    TipoRiesgoId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Poliza_Tiporiesgo_TipoRiesgoId",
                        column: x => x.TipoRiesgoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PolizaCliente", x => new { x.PolizaId, x.ClienteId });
                    table.ForeignKey(
                        name: "FK_PolizaCliente_Cliente_ClienteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Poliza_TipoRiesgoId",
                table: "Poliza",
                column: "TipoRiesgoId");

            migrationBuilder.CreateIndex(
                name: "IX_PolizaCliente_ClienteId",
                table: "PolizaCliente",
                column: "ClienteId");
        }
